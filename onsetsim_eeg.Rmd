...
# load("./data/onsetsim_n50_var1_5_eegnoise.RData") # outvar = 1.5
...
ggsave(filename = "./figures/figure3.pdf", width = 10, height = 5)
```

## Mode
```{r}
print("Mode:")
print(paste("FDR =",find_mode(simres.fdr)))
print(paste("MAX =",find_mode(simres.max)))
print(paste("Cluster =",find_mode(simres.cs)))
...
res.var <- matrix(0, nrow = 4, ncol = n_length)
...
ggsave(filename = "./figures/figure4.pdf", width = 15, height = 10)
```
